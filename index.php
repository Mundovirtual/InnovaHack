    ...
    <body>
        <div class="ventanaprincipal">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="form-group">
                    <div class="row col-lg-12">
                        <a class="navbar-brand" href="index.php">
                            <img class="img-responsive" src="imagenes/logoinnovahack.png" width="30%"/>
                        </a>
                    </div>
                </div>
                <a class="navbar-brand" href="index.php">
                ...
                <button aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation" class="boton navbar-toggler" data-target="#navbarNavDropdown" data-toggle="collapse" type="button">
                    <span class="icono navbar-toggler-icon">
                    </span>
                </button>
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="InnovaWeeKend.html">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="InnovaHack.html">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Lideres.html">
                            ...
                            <?php 
                                ...
                                if($resultado->num_rows > 0){
                                    while ($row = mysqli_fetch_array($resultado)) {?>
                                        ...
                                        <p><i class="fas fa-check text-danger"> </i> <?php echo utf8_encode($row['InfAsesoria']) ?></p>
            ...
            <div class="container-aliados">
                ...
                <div class="container-cuadro">
                    <div class="row">
                        ...
                        <div class="contenedor">
                           <img src="imagenes/labsol/Logo_SF2018_2.png">
                        </div>
                    </div>
                    <div class="row">
                        <div class="contenedor">
                           <img src="imagenes/labsol/LABSOL1/Innovation Labs Network Logo.png">
                        </div>
                        <div class="contenedor">
                ...
                <div class="Frases">
                    <div class="carousel slide" data-ride="carousel" id="carouselExampleSlidesOnly">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="titulofrase col-lg-12">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="titulofrase col-lg-12">
                                        <h1 class="titulofrases text-center">
                                            Innovación
                                        </h1>
                                    </div>
                                </div>
